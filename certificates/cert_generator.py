...
subject = issuer = x509.Name([
    ...
    x509.NameAttribute(NameOID.STATE_OR_PROVINCE_NAME, u"Aargau"),
    x509.NameAttribute(NameOID.LOCALITY_NAME, u"Baden"),
    x509.NameAttribute(NameOID.ORGANIZATION_NAME, u"ABB TS"),
...
print("Private key and self-signed certificate have been generated "
